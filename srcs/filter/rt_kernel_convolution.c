...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   rt_kernel_convolution.c                            :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: juthomas <juthomas@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/06/24 05:24:16 by juthomas          #+#    #+#             */
/*   Updated: 2018/06/29 14:33:07 by juthomas         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
					...
					int color, int divi)
{
	...
	ret = (int)(((unsigned char)kernel[2][2][color] * matrix[0][0]
		...
		+ (unsigned char)kernel[0][0][color] * matrix[2][2]) / (int)divi);
	ret = ret < 0 ? 0 : ret;
