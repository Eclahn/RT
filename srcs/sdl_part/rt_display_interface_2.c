...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   rt_display_interface_2.c                           :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: juthomas <juthomas@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/06/29 10:25:38 by juthomas          #+#    #+#             */
/*   Updated: 2018/06/29 12:29:58 by juthomas         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	this_display_interface_3(t_idisplay *norm, int *cur_light)
{
	...
	else if (norm->button[norm->len].value == V_GO_OTHER)
		*norm->id = I_OTHER;
												...
												int *cur_obj, int *cur_light)
{
	...
	if ((i = this_display_interface_1(norm, cur_obj, cur_light)) && i == 1)
		...
		&& i == 1)
		return (1);
	else if (i && (i = this_display_interface_3(norm, cur_light))
		&& i == 1)
		return (1);
