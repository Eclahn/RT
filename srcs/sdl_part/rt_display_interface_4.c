...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   rt_display_interface_4.c                           :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: juthomas <juthomas@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/06/29 12:51:56 by juthomas          #+#    #+#             */
/*   Updated: 2018/06/29 13:07:42 by juthomas         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	this_display_interface_1(t_idisplay *norm)
{
	...
	if (((*norm).button[(*norm).len].value == V_CUR_SCENE && *(*norm).val
	+ (*norm).pouet >= (int)(*norm).win->stock.num_scn)
		...
		|| ((*norm).button[(*norm).len].value == V_CUR_OBJ && *(*norm).val
